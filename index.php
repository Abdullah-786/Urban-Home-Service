...
<head>
	...
	<title>Urban Home Services|| Home Page</title>
...
<body>
	...
	<div class="theme-wrap clearfix">
			...
			<div class="container">
				<div class="">
					<ul><!-- SLIDE  -->
						...
						<!-- MAIN IMAGE -->
							<img src="images/main.jpg" alt="item slide" width="100%">
						<!-- LAYERS -->	
		...
		<section id="search-form">
			<div class="container">
				<div class="search-form-wrap" style="background-color:#972a89">
...
<option value="<?php echo htmlentities($row->Category);?>"><?php echo htmlentities($row->Category);?></option>
 <?php } ?> 
						...
						<div class="submit-field-wrap pull-right">
							<input class="search-form-submit bgyallow-1 white" name="search" type="submit" style="background-color:#6ddfd9"/>
						</div>
					</form>
				</div>
			</div>
